"""
Django settings for broken_truth_dev_104322 project.
...
ROOT_URLCONF = 'broken_truth_dev_104322.urls'
...
WSGI_APPLICATION = 'broken_truth_dev_104322.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_truth_dev_104322 API",
    "DESCRIPTION": "API documentation for broken_truth_dev_104322 App",
    "VERSION": "v1",
}
